...
electron_1.contextBridge.exposeInMainWorld("electronAPI", {
    getCustomerList: () => __awaiter(void 0, void 0, void 0, function* () {
        return yield electron_1.ipcRenderer.invoke("get-customer-list");
    }),
    saveCustomerInfo: (customer) => __awaiter(void 0, void 0, void 0, function* () {
        return yield electron_1.ipcRenderer.invoke("save-customer", customer);
    }),
