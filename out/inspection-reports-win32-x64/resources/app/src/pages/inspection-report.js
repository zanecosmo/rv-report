...
const inspection_form_1 = require("../components/inspection-form");
const types_1 = require("../types");
const utils_1 = require("../utils/front-end/utils");
const jspdf_1 = require("jspdf");
;
const InspectionReport = ({ report, setReport, setAddingReport }) => {
    const flattenedState = (0, utils_1.flatten)(report.form.categories);
    const [state, setState] = (0, react_1.useState)(flattenedState);
    const [RVInfo, setRVInfo] = (0, react_1.useState)(report.RVInfo);
    const saveForm = () => __awaiter(void 0, void 0, void 0, function* () {
        report.form.categories = (0, utils_1.unflatten)(state);
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("div", { className: "printable-form" },
            react_1.default.createElement("div", { className: "report-header" },
                ...
                react_1.default.createElement("hr", null)),
            react_1.default.createElement(inspection_form_1.InspectionForm, Object.assign({}, { state, setState })))));
};
